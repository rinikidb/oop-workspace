...
int main(){
    ...
    cout << "Weight of the Air Vehicle is: " << AirVehicle.get_weight() << "kgs" << endl;
    ...
    AirVehicle.set_weight(450);

    cout << "Number of flights now: " << AirVehicle.get_numberOfFlights() << endl;
    cout << "New Weight of the Air Vehicle is: " << AirVehicle.get_weight() << "kgs" << endl;
